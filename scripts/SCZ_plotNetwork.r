##########################################################################################
## Generate network plot and pie charts for SCZ PPI data
##
## Author: Yu-Han Hsu
##########################################################################################
...
pdf("../output/SCZ_NetworkPlot.pdf",width=7,height=7)
...
# plot pie charts
pdf("../output/SCZ_NetworkPieCharts.pdf",width=3,height=3)
...
ggplot(inwebTable, aes(x="", y=Freq, fill=IsInWeb)) +
geom_bar(width=1, stat="identity", color="black") +
coord_polar("y") +
